...
async function main() {
  ...
  const count = await client.readContract({ address: contractAddress, functionName: "get_world_count" });
  if (String(count) !== "0") throw new Error("new deployment did not return zero world count");
